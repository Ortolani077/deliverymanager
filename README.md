Gerenciamento Delivery

O sistema Gerenciamento Delivery foi desenvolvido para permitir que restaurantes gerenciem e acompanhem os pedidos feitos pelos clientes através do sistema Delivery. 
Ele oferece uma interface intuitiva para visualizar, editar e atualizar os status dos pedidos de forma eficiente, além de fornecer insights valiosos sobre os produtos mais vendidos,
otimizando a operação do restaurante.
...
## Tecnologias Usadas
    ...
    Chart.js (para a geração de gráficos interativos)
...
Este projeto foi desenvolvido por Rodrigo Ortolani. Contribuições não são necessárias neste momento, mas sugestões ou melhorias são sempre bem-vindas.
